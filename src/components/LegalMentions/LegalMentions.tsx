...
function LegalMentions() {
  return (
    <div className="legalm-container">
      ...
      <h2 className="legalm-subtitle">1. Présentation de l&#39;Application</h2>
      <p className="legalm-content">
        La plateforme Amidon (ci-après dénommée &#34; l&#39;Application &#34;)
        est une application web qui facilite le don d&#39;objets entre amis.
        Elle permet aux utilisateurs de partager des objets dont ils souhaitent
        se séparer, avec leurs amis via un code donneur, et de réserver des
        objets mis à disposition par leurs contacts. Bien que l&#39;Application
        privilégie le don gratuit, les utilisateurs ont également la possibilité
        de fixer un prix pour leurs objets. Toutefois, l&#39;Application ne
        prend pas en charge les transactions financières, ni la messagerie entre
      ...
      <h2 className="legalm-subtitle">
        4. Inscription et Utilisation de l&#39;Application
      </h2>
      ...
      <h2 className="legalm-subtitle">5. Limitation de Responsabilité</h2>
      ...
      <h2 className="legalm-subtitle">7. Propriété Intellectuelle</h2>
      <p className="legalm-content">
      ...
      <h2 className="legalm-subtitle">8. Résiliation</h2>
      <p className="legalm-content">
      ...
      <h2 className="legalm-subtitle">9. Droit Applicable et Juridiction</h2>
      <p className="legalm-content">
